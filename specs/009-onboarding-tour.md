...
- [ ] Engine própria com spotlight + popover + teclado + persistência no banco.
- [ ] 7 tours definidos e funcionando; `data-tour` presente em todos os alvos.
- [ ] Auto-start no primeiro acesso + reabertura manual pelo `?`.
- [ ] Teste de componente da engine (navegação, skip, alvo ausente) + E2E nº 6 cobrindo o ciclo completo.
- [ ] ADR-010 escrito.
